#ifndef ANALYSIS_3LEPTONS_H
#define ANALYSIS_3LEPTONS_H
...
class Analysis_3Leptons : public Analysis
{
  public:
    // Constructor
    Analysis_3Leptons(Arbusto &arbusto_ref, Nano &nt_ref, HEPCLI &cli_ref, Cutflow &cutflow_ref) : Analysis(arbusto_ref, nt_ref, cli_ref, cutflow_ref) {}
    ...
    void initCutflow() override
    {
        ...
        // Lepton selection
        Cut *cut_threeleptons = new LambdaCut("ThreeLeptons", [&]() { return (cutflow.globals.getVal<LorentzVectors>("vvh_skim_lep_p4s").size() >= 3); });
        ...
        //    Cut *cut_atleast2jets = new LambdaCut(
        //        "AtLeast2Jets",
        //        [&]()
        //        {
        //          return (cutflow.globals.getVal<int>("n_vvh_veto_jets") >= 2);
        //        });
        //    vCutflowCuts_.push_back(cut_atleast2jets);

        finalSkimmerCut_ = "LeadingLeptonPT";

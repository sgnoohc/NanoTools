...
class Analysis_2Leptons_2FJ : public Analysis
{
  public:
    // Constructor
    Analysis_2Leptons_2FJ(Arbusto &arbusto_ref, Nano &nt_ref, HEPCLI &cli_ref, Cutflow &cutflow_ref) : Analysis(arbusto_ref, nt_ref, cli_ref, cutflow_ref) {}
    ...
    void initCutflow() override
    {
        ...
        Cut *cut_atleast2fatjets = new LambdaCut("AtLeast2FatJets", [&]() { return (cutflow.globals.getVal<int>("n_vvh_veto_fatjets") >= 2); });

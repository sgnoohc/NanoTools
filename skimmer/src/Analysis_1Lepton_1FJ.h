#ifndef ANALYSIS_1LEPTON_1FJ_H
#define ANALYSIS_1LEPTON_1FJ_H
...
class Analysis_1Lepton_1FJ : public Analysis
{
  public:
    // Constructor
    Analysis_1Lepton_1FJ(Arbusto &arbusto_ref, Nano &nt_ref, HEPCLI &cli_ref, Cutflow &cutflow_ref) : Analysis(arbusto_ref, nt_ref, cli_ref, cutflow_ref) {}
    ...
    void initCutflow() override
    {
        ...
        // Lepton selection
        Cut *cut_onelepton = new LambdaCut("OneLepton", [&]() { return (cutflow.globals.getVal<LorentzVectors>("vvh_skim_lep_p4s").size() >= 1); });
        vCutflowCuts_.push_back(cut_onelepton);
